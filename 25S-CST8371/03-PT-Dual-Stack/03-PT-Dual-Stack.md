...
| ISP-A  | G0/0      | `192.0.2.1/24`     | `2001:db8:192::1/64`     | `fe80::a`  | To Server Network |
| ISP-B  | S0/0/0    | `203.0.113.250/30` | `2001:fab:203:b::250/64` | `fe80::b`  | To Edge           |
| ISP-B  | G0/1      | `192.0.2.2/24`     | `2001:db8:192::2/64`     | `fe80::b`  | To Server Network |

# 26F-CST8371 — Introduction to Enterprise Networking

## Repository Status

This directory is the working course structure for the **Fall 2026** delivery of **CST8371 — Introduction to Enterprise Networking**.

This repo section is used to organize student-facing labs, challenge/audit files, examples, CML topologies, and visual references.
...
| `cml/`          | CML topology files used for labs and examples                                         |
...
| `reflections/`  | Student reflection prompts and submissions                                            |
| `resources/`    | Supplementary readings and reference material                                         |
